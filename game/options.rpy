...
python early:
    config.save_directory = "Dangerous_Fantasy-1448076310"
...
init python:
    ...
    build.directory_name = "Dangerous_Fantasies-0.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Dangerous_Fantasies"
    ...
    build.classify('notes.txt', None)
    build.classify('**/images/originale/**', None)
    build.classify('**/.**', None)
    build.classify('**/#**', None)
